...
# Maximum matches returned by search_file.
MAX_REVERSE_MATCHES = 20

# Maximum context lines (before/after) for search_file.
...
# Files larger than this are rejected by read_file and search_file.
